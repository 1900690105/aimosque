...
//         adminId: "admin",
//         fullName: "Admin User",
//         mosqueName: "Sample Mosque",
//         mosqueHistory: "A beautiful mosque...",
...
//             Demo credentials: Admin ID: <strong>admin</strong>, Password: <strong>password</strong>
//           </p>
//         </div>
  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4">
      ...
      >
        ...
        <div className="pt-2 text-center">
          <p className="text-xs text-slate-500 dark:text-slate-400">
            Demo credentials: Admin ID: <strong>admin</strong>, Password:{" "}
